...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'newdir05.data';
    var REMOTE_PACKAGE_BASE = 'newdir05.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3422236;
      var PACKAGE_UUID = '19d665c4-9425-4348-a982-44f2aca6f3d6';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 761548, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(761548, 761569, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(761569, 761591, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(761591, 762099, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(762099, 2519639, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2519639, 3394611, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3394611, 3422236, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_newdir05.data');

    };
    Module['addRunDependency']('datafile_newdir05.data');
